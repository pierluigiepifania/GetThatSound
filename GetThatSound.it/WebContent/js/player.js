...
function updatePlayhead() { 
	...
	var s1 = parseInt(audioTrack.duration % 60);
	var m1 = parseInt((audioTrack.duration / 60) % 60);
	s1 = (s1 >= 10) ? s1 : "0" + s1;
	m1 = (m1 >= 10) ? m1 : "0" + m1;
	setText(timesong, m1+":"+s1);
}
...
timesong = document.getElementById("timesong");
setText(playButton, "Play");
setText(muteButton, "volumehigh");
setAttributes(playButton, { "type": "button", "class": "ss-icon" , "id": "playDatMusic"});
setAttributes(muteButton, { "type": "button", "class": "ss-icon" });
muteButton.style.display = "block";
muteButton.style.margin = "0 auto";
setAttributes(volumeSlider, { "type": "range", "min": "0", "max": "1", "step": "any", "value": "1", "orient": "horizontal", "id": "volumeSlider" });
