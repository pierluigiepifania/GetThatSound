...
public class TC_2_3_4 {
	...
	@Test
	public void testTC234() throws Exception {
		...
		driver.findElement(By.xpath("//th[contains(@id, 'album')]")).clear();
		driver.findElement(By.xpath("//th[contains(@id, 'album')]")).sendKeys("traccia$");
